...
function custom_enqueue_gf_css() {
	wp_enqueue_style( 'css_inscripcion', get_stylesheet_directory_uri() . '/css/encuesta_nombre_biblioteca.css' );
...
function custom_enqueue_gf_js() {
	wp_enqueue_script('javascript_inscripcion',  get_stylesheet_directory_uri() . '/js/encuesta_nombre_biblioteca.js', array(), '1.0', true);
}
